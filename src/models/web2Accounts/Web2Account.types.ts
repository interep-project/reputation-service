...
import { ITwitterAccountDocument, TwitterReputation } from "./twitter/TwitterAccount.types"
...
export function isTwitterAccount(web2Account: IWeb2AccountDocument): web2Account is ITwitterAccountDocument {
