...
import { IBaseTwitterAccount, ITwitterAccountDocument, ITwitterAccountModel } from "./TwitterAccount.types"
...
const TwitterAccountSchema = new Schema<ITwitterAccountDocument, ITwitterAccountModel>(TwitterAccountSchemaFields)
