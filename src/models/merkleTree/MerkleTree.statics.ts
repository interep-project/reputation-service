...
import { IMerkleTreeNodeDocument, IMerkleTreeNodeKey, IMerkleTreeZeroDocument } from "./MerkleTree.types"
...
export async function getNumberOfNodes(this: typeof MerkleTreeNode, groupId: string, level: number): Promise<number> {
