...
import handler from "src/pages/api/tokens/[contractAddress]/[id]"
import { clearDatabase, connect, dropDatabaseAndDisconnect } from "src/utils/server/testDatabase"

jest.spyOn(TokenController, "getTokenByContractAndId")
...
describe("api/linking/checkLink", () => {
    ...
    it("should call getTokenByContractAndId", async () => {
        ...
        expect(TokenController.getTokenByContractAndId).toHaveBeenCalledWith(req, res)
    })
})
