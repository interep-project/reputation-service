...
describe("api/reputation/twitter", () => {
    ...
    describe("index", () => {
        ...
        it("should return the account reputation", async () => {
            ...
            expect(res._getData().basicReputation).toBe(accountReputation.basicReputation)
        })
    })
    ...
    describe("me", () => {
        ...
        it("should call getMyTwitterReputation", async () => {
            ...
            // Expect
            expect(TwitterAccountController.getMyTwitterReputation).toHaveBeenCalledWith(req, res)
        })
    })
})
