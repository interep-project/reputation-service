...
describe("getTwitterReputation", () => {
    ...
    it("should return a 500 if user has no twitter reputation", async () => {
        ...
        checkTwitterReputationByUsernameMocked.mockImplementation(() => Promise.resolve(null))
    ...
    it("should return the account reputation queried by username", async () => {
        ...
        checkTwitterReputationByUsernameMocked.mockImplementation(() => Promise.resolve(accountReputation))
        ...
        expect(res._getData().data.basicReputation).toBe(accountReputation.basicReputation)
    })
    ...
    it("should return the account reputation queried by id", async () => {
        ...
        checkTwitterReputationByIdMocked.mockImplementation(() => Promise.resolve(accountReputation))
...
describe("getMyTwitterReputation", () => {
    ...
    it("should return the twitter reputation of a signed in user", async () => {
        ...
        expect(checkTwitterReputationByIdMocked).toHaveBeenCalledWith(twitterUserId)
