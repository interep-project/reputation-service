        ...
        <>
            <Container flex="1" mb="80px" mt="180px" px="80px" maxW="container.lg">
                <Heading as="h2" mb="30px" size="xl">
                    Providers
                    <Tooltip
                        label="Select one of our supported providers to join a off-chain group."
            ...
            <Container flex="1" mb="80px" mt="180px" px="80px" maxW="container.lg">
                <Heading as="h2" mb="30px" size="xl">
                    On-chain Groups
                    <Tooltip
                        label="Select one of our supported providers to join a on-chain group."
                        placement="right-start"
                    >
                        <span>
                            <Icon
                ...
                <HStack spacing={4} align="left">
                    <Button
                        onClick={() => router.push("/onchain/brightid")}
                        colorScheme="orange"
                        variant="semisolid"
                        isDisabled={!!session}
                    >
